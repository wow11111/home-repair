package com.example.repairsystem.ui.notifications;
...
public class NotificationsFragment extends Fragment implements MyOneLineView.OnRootClickListener{
    ...
    private void initData() {
        ...
        btn_quit_to_login=getActivity().findViewById(R.id.btn_quitto_login);
       ...
       btn_quit_to_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(getContext(), com.example.repairsystem.init.LoginActivity.class);
    ...
    private void init() {
        ...
        thereItem.initMine(R.mipmap.mycharge, "我的报修","", true);
